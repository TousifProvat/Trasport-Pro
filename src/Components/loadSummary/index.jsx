...
const LoadSummary = () => {
  ...
  //hooks
  useEffect(() => {
    fetchLoadSummary(loadId);
  }, [loadId]);

  //func
  const fetchLoadSummary = async (id) => {
    try {
      setLoading(true);
      const { data } = await axios.get(`/load/${id}`);
      setAllValues({ ...data.load, customer: data.load.customer?._id });
      setLoading(false);
    } catch (err) {
      console.log({ err });
  ...
  const updateLoad = async (id, values) => {
    try {
      setLoading(true);
      const res = await axios.put(`/load/${id}`, values);
  ...
  return (
    <Container>
      <Container>
        <h4 className="mt-5 mb-3">Load Summary</h4>
        <hr></hr>
      </Container>
      {loading && <Loader />}
      {!loading && (
              ...
              <Row className="mt-3">
                <Col>
                  ...
                  <Form.Control
                    ...
                    onChange={onChange}
                    value={allValues.deliveryAddress}
                  />
                </Col>
              </Row>
              <Row className="mt-3">
          ...
          <Row className="mt-3">
            ...
            <Col sm={6}>
              ...
              <Form.Control
                ...
                name="commodityValue"
                onChange={onChange}
                value={allValues.commodityValue}
              />
            </Col>
          </Row>
          <Row className="mt-3">
            ...
            <Col sm={6}>
              ...
              <Form.Control
                ...
                onChange={onChange}
                value={allValues.internalComments}
              />
            </Col>
          </Row>
          <Row className="mt-3">
            <Col sm={6}>
              ...
              <Form.Control
                ...
                onChange={onChange}
                value={allValues.externalComments}
              />
            </Col>
            <Col sm={6}></Col>
          </Row>
